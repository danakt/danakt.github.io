...
export default function Index() {
  return (
    <Page title="Да это же Данакт">
      ...
      <p>
        Прямо сейчас я нахожусь в поисках работы на должность javascript-разработчика, если у вас есть что предложить,
        вы можете рассмотреть <a href="/cv">моё резюме</a>.
      </p>
