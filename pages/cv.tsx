...
export default function Cv() {
  return (
    <Page title="Резюме">
      ...
      >
        <p>
          На этой странице находится моё резюме. В текущий момент я работаю в компании{' '}
          <a href="https://3commas.io/" target="_blank" rel="noreferrer noopener">
            3Commas
          </a>
          , однако открыт к интересным предложениям.
        </p>
