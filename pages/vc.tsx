...
export default function Vc() {
  return (
    <Page title="Резюме">
      ...
      >
        <p>
          Если вы видите это, то скорее всего я открыт к предложениям о работе. Коротко обо мне: всесторонне умею во
          фронтенд, люблю TypeScript и React, базово умею в бэкенд, быстро адаптируюсь к новым технологиям, хорошо
          общаюсь с людьми.
        </p>
      </WithAside>
      ...
      <p>
        Разрабатывал новые внутренние продукты для сотрудников Альфа-Банка: контрукторы писем, баннеров, приложение для
      ...
      <p>По началу работал как дизайнер/верстальщик, рисовал иллюстрации и интерфейсы приложений в Adobe Photoshop.</p>

      <Heading>Некоммерческая деятельность</Heading>

      <p>Делаю митапы в SPB Frontend, с 2017-го года провожу фронтенд-звтраки в СПб (пока на паузе из-за карантина).</p>
      <p>
