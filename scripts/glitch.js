var Glitch = (function () {
    function Glitch() {
        ...
        setTimeout(this.runGlitch, this.getRandomInt(5000));
        this.videoElement.addEventListener('ended', function (event) {
            ...
            _this.glitchTimeout = _this.setTimeout(_this.runGlitch, _this.getRandomInt(1e4));
        });
    }
    Glitch.prototype.runGlitch = function () {
        clearTimeout(this.glitchTimeout);
        this.showGlitch();
        setTimeout(this.hideGlitch, this.getRandomInt(700) + 70);
        this.glitchTimeout = this.setTimeout(this.runGlitch, this.getRandomInt(1e4));
    };
    Glitch.prototype.showGlitch = function () {
        clearInterval(this.glitchInterval);
        this.randomizeGlitchFrame();
        this.glitchInterval = this.setInterval(this.randomizeGlitchFrame, 33);
    };
